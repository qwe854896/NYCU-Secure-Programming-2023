classes = [
    ...
    "class 'uwsgi._Input'",
    "class 'uwsgi.SymbolsImporter'",
    "class 'uwsgi.ZipImporter'",
    "class 'uwsgi.SymbolsZipImporter'",
    "class '_ast.AST'",
...
# Find string with "os" substring, then print its index
def find_os():
    for i in range(len(classes)):
        if "os._wrap_close" in classes[i]:
            print(i)
